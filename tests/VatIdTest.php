...
//    {
//        $this->assertTrue(VatId::verify('ES99999999R', Country::Spain));
//    }
//
...
//    {
//        $this->assertTrue(VatId::verify('SE556858087001', Country::Sweden));
//    }
//
//    public function testVerifySwedenInvalid(): void
//    {
//        $this->assertFalse(VatId::verify('SE556858087101', Country::Sweden));
//    }
//
//    public function testVerifySwedenWrongSuffixInvalid(): void
//    {
//        $this->assertFalse(VatId::verify('SE556858087002', Country::Sweden));
//    }
    ...
    {
        $this->assertSame('DE345789003', VatId::format('DE 345 789 003', Country::Germany));
    }
//
//    public function testFormatStripsDashes(): void
//    {
//        $this->assertSame('PL8567346215', VatId::format('PL856-734-62-15', Country::Poland));
//    }

    public function testFormatUppercases(): void
    {
        $this->assertSame('DE345789003', VatId::format('de345789003', Country::Germany));
    }
    ...
    {
        $this->assertSame('DE 345 789 003', VatId::format('DE345789003', Country::Germany, Format::human));
    }
//
//    public function testFormatHumanAustria(): void
//    {
//        $this->assertSame('ATU 13585627', VatId::format('ATU13585627', Country::Austria, Format::human));
//    }
//
//    public function testFormatHumanNetherlands(): void
//    {
//        $this->assertSame('NL 123456782 B01', VatId::format('NL123456782B01', Country::Netherlands, Format::human));
//    }
//
//    public function testFormatHumanPoland(): void
//    {
//        $this->assertSame('PL 856-734-62-15', VatId::format('PL8567346215', Country::Poland, Format::human));
//    }

    public function testFormatHumanFrance(): void
    {
        $this->assertSame('FR 83 404 833 048', VatId::format('FR83404833048', Country::France, Format::human));
    }
}